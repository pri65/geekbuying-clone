let allCatagories = function () {
  return `<div id="allCatagoryIn">
    <h3>All Catagories</h3>

    <div id="smartHomeandgarden">
      <span class="left">
        <span>Smart Home & Garden</span>
        <span id="smartHomeandgardenCount"></span>
      </span>

      <span class="right">
        <!-- // down key  -->
        <img src="./images/expandDownBlack.png" alt="" />
      </span>
    </div>

    <div id="consumerElectronics">
      <span class="left">
        <span>Consumer Electronics</span>
        <span id="consumerElectronicsCount"></span>
      </span>
    ...
    <div id="sportsAndOutdoor">
      <span class="left">
        <span>Sports & Outdoors</span>
        <span id="sportsAndOutdoorCount"></span>
      </span>
    ...
    <div id="toysAndHobbies">
      <span class="left">
        <span>Toys & Hobbies</span>
        <span id="toysAndHobbiesCount"></span>
      </span>
    ...
    <div id="automobilesAndMotorcycle">
      <span class="left">
        <span>Automobiles & Motorcycles</span>
        <span id="automobilesAndMotorcycleCount"></span>
      </span>
    ...
    <div id="computerTabletsAccessories">
      <span class="left">
        <span>Computers, Tablets & Accessories</span>
        <span id="computerTabletsAccessoriesCount"></span>
      </span>
    ...
    <div id="tvBoxesAndMiniPc">
      <span class="left">
        <span>TV Boxes & Mini PCs</span>
        <span id="tvBoxesAndMiniPcCount"></span>
      </span>
    ...
    <div id="wearableDevices">
      <span class="left">
        <span>Wearable Devices</span>
        <span id="wearableDevicesCount"></span>
      </span>
    ...
    <div id="phoneAndAccessories">
      <span class="left">
        <span>Phones & Accessories</span>
        <span id="phoneAndAccessoriesCount"></span>
      </span>
    ...
    <div id="securitySystems">
      <span class="left">
        <span>Security Systems</span>
        <span id="securitySystemsCount"></span>
      </span>
...
let navTopBarExport = function () {
  ...
  <div id="supportCenter">
    ...
    <div id="supportDropDown">
      ...
      <div>
        <img src="./images/question (1).png" alt="" /><span
          >Help Center</span
        >
      </div>
    </div>
...
<div id="middleOfTheNav">
  <div id="middleOfTheNavIn">
    <div id="logoNav">
      <!-- // redirect index page  -->
      <img src="./images/geek_logo.png" alt="" />
    </div>
    ...
    <div id="signbarNav">
      ...
      <div id="signInUpNav">
        ...
        <div id="signInDropDownNav">
          ...
          <span>Join</span><span>Sign In</span>
        </div>
      </div>
...
<div id="tailOfTheNav">
    ...
    <div id="catagoriesNavTailDropDown">
        ...
        <div id="localwarehouseOptions" class="parentside">
          ...
          <div class="child3">
            <div id="localWarehouseCHildImage">
              <img src="./images/category-1301-6ETJOmbg.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
      <div id="sportsHoverNav">
        ...
        <div class="parentside" id="sportsHoverInsideNav">
          ...
          <div class="child3">
            <div id="sportsNavImg">
              <img src="./images/category-1241-6g70jAZ2.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="consumersElectronicsInNav" class="parentside">
          ...
          <div class="child3">
            <div id="consumersImgNavIn">
              <img src="./images/consumerElectronics.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="tvboxMiniPcNavIn" class="parentside">
          ...
          <div class="child3">
            <div id="tcBoxMiniPcNavImg">
              <img src="./images/tvMiniBox.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="computerTabletNavSlideParent" class="parentside">
          ...
          <div class="child3">
            <div id="computertabletnavImageIn">
              <img src="./images/computerTablet.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="toysHobbiesNavInParentSlide" class="parentside">
          ...
          <div class="child3">
            <div id="toysHobbiesnavImage">
              <img src="./images/toysHobbies.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="phoneAccessoriesNavParent" class="parentside">
          ...
          <div class="child3">
            <div id="phoneAccesorriesNavImage">
              <img src="./images/phoneAccesorries.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="automibileNavParentIn" class="parentside">
          ...
          <div class="child3">
            <div id="automobilePartImage">
              <img src="./images/automobilePart.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="wearableDeviceNaveParentSlide" class="parentside">
          ...
          <div class="child3">
            <div id="wearableDeviceNavImage">
              <img src="./images/wearablesDevice.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="securityCheckNavParentIn" class="parentside">
          ...
          <div class="child3">
            <div id="securityCheckNavImage">
              <img src="./images/securitySystem.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="fashionNavParentIn" class="parentside">
          ...
          <div class="child3">
            <div id="fashionNavImage">
              <img src="./images/fashionImage.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <h3><a href="">New</a></h3>
  <h3><a href="">Bestselling</a></h3>
  <h3><a href="">Brand</a></h3>
  <h3><a href="">Clearance</a></h3>
  <h3><a href="">Deals</a></h3>
  <h3><a href="">Coupon</a></h3>
  <h3><a href="">App Only</a></h3>
</div>
  `;
};

export { allCatagories, navTopBarExport };
